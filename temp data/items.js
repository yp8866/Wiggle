...
for(var cl=0;cl<14;cl++){
    ...
    for(let k=0;k<10;k++){
        let id=(cl*10)+k;
          ...
          let title=itemarray[id].title;
          let price=itemarray[id].price;
          let image=itemarray[id].image;
      
      if(count%10 <4){
          let othrpric=price+200;
          ...
          <div class="dishitem">
                  <img src='${image}' alt="">
                  <h3>${title}</h3>
                  <h5 class="offer"><b>Offer Price:&nbsp;</b>&#8377;${price}/-</h5>
                  <h5><b>Normal Price:&nbsp;</b><strike>&#8377;${othrpric}/-</strike></h5>
                  <h5><b>Restaurant Name:&nbsp;</b>${restraname[cl]}</h5>
